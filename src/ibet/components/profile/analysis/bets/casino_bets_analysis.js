...
export class CasinoBetsAnalysis extends Component {
            ...
            <div className={classes.root}>
                <Grid container>
                    ...
                    <Grid item xs={8} className={classes.titleCell}>
                        <span className={classes.title}>Live Casino</span>
                    </Grid>
                    <Grid item xs={2} className={classes.backCell}>
                    </Grid>
...
export default withStyles(styles)(injectIntl(connect(mapStateToProps, { authCheckState })(CasinoBetsAnalysis)));