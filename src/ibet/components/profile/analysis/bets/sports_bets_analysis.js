...
export class SportsBetsAnalysis extends Component {
    ...
    render() {
        ...
        let placedLabel = formatMessage({ id: "analysis.placed" });
        let categoryLabel = formatMessage({ id: "analysis.category" });
        let winlossLabel = formatMessage({ id: "analysis.winloss" });
            ...
            <div className={classes.root}>
                <Grid container>
                    ...
                    <Grid item xs={8} className={classes.titleCell}>
                        <span className={classes.title}>Sports Bets</span>
                    </Grid>
                    <Grid item xs={2} className={classes.backCell}>
                    </Grid>
                    <Grid item xs={12}>
                        <Paper className={classes.contentPaper}>
                            <Grid container>
                                ...
                                <Grid item xs={6} className={classes.gridTitleCell}>
                                    {categoryLabel}
                                </Grid>
                                ...
                                <Grid item xs={6} className={classes.contentCell}>
                                    Sports Bets
                                </Grid>
...
export default withStyles(styles)(injectIntl(connect(mapStateToProps, { authCheckState })(SportsBetsAnalysis)));