    ...
    render() {
        ...
        return (
          ...
          <div className='row'>
            ...
            {/* <div className='type'>
                <NavLink to='/game_list/LiveCasino' style={{ textDecoration: 'none' }}>
                    <div className='title-game'> 
                        <FormattedMessage id="live_casino_type.live_casino" defaultMessage='LiveCasino' />
                    </div>
                    <br/>
            ...
            <div className='type'>
                <NavLink to='/game_list/Casino' style={{ textDecoration: 'none' }} >
                    <div className='title-game'> 
                        <FormattedMessage id="live_casino_type.casino" defaultMessage='Casino' />
                    </div>
                    <br/>
            ...
            <div className='type'>
                <NavLink to='/game_list/Poker' style={{ textDecoration: 'none' }} >
                    <div className='title-game'> 
                        <FormattedMessage id="live_casino_type.poker" defaultMessage='Poker' />
                    </div>
                    <br/>
            ...
            <div className='type'> 
                <NavLink to='/game_list/Guide' style={{ textDecoration: 'none' }} >
                    <div className='title-game'> 
                         <FormattedMessage id="live_casino_type.guide" defaultMessage='Guide' />
                    </div>
                    <br/>
