...
class ForgetPasswordValidation extends Component {
        ...
        return (
            <div style={{ backgroundColor: 'white', minHeight: 650, width: 662 }}>
                <div className='signup-title'>
                    ...
                    <img src={images.src + 'close_page.svg'} alt="" style={{ cursor: 'pointer', position: 'absolute', top: 8, left: 620, height: 40, width: 20 }}
                        onClick={() => {
                            this.props.hide_forget_password_validation();
                        }}
                    />
...
export default withStyles(styles)(connect(mapStateToProps, { hide_forget_password_validation })(ForgetPasswordValidation));
