          ...
          <div className='row'>
            ...
            {/* <div className='type'>
                <NavLink to='/game_list/Sports' style={{ textDecoration: 'none' }}>
                    <div className='title-game'> 
                        <FormattedMessage id="sports_type.sports" defaultMessage='Sports' />
                    </div>
                    <br/>
            ...
            <div className='type'>
                <NavLink to='/game_list/Casino' style={{ textDecoration: 'none' }} >
                    <div className='title-game'> 
                        <FormattedMessage id="sports_type.casino" defaultMessage='Casino' />
                    </div>
                    <br/>
            ...
            <div className='type'>
                <NavLink to='/game_list/Poker' style={{ textDecoration: 'none' }} >
                    <div className='title-game'> 
                        <FormattedMessage id="sports_type.poker" defaultMessage='Poker' />
                    </div>
                    <br/>
            ...
            <div className='type'> 
                <NavLink to='/game_list/Guide' style={{ textDecoration: 'none' }} >
                    <div className='title-game'> 
                         <FormattedMessage id="sports_type.guide" defaultMessage='Guide' />
                    </div>
                    <br/>
