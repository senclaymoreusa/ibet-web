...
const SVG = ({
  ...
  >
    ...
    >
      <g
        id="navigation"
        transform="translate(-1304.000000, -21.000000)"
      ...
      >
        <g id="Login-Elements">
          <g transform="translate(1280.000000, 13.000000)">
            <g id="Open-Account">
              <path
                d="M43,14.6367187 C43,17.5362187 40.6495,19.8867188 37.75,19.8867188 C34.8505,19.8867188 32.5,17.5362187 32.5,14.6367187 C32.5,11.7372188 34.8505,9.38671875 37.75,9.38671875 C40.6495,9.38671875 43,11.7372188 43,14.6367187 Z M37,24.3867187 C40.8128,24.3867187 44.2816,25.7412188 46.4976,26.8602187 C48.032,27.6372188 49,29.1792188 49,30.8757188 L49,31.6992187 C49,32.6307187 48.2336,33.3867187 47.2864,33.3867187 L26.7136,33.3867187 C25.7664,33.3867187 25,32.6307187 25,31.6992187 L25,30.8757188 C25,29.1792188 25.968,27.6372188 27.5024,26.8602187 C29.7184,25.7412188 33.1872,24.3867187 37,24.3867187 Z"
                id="User"
              ></path>
            </g>
          </g>
...
export class TopNavbar extends React.Component {
  ...
  constructor(props) {
    ...
    this.bankingProfileMenuItemClick = this.bankingProfileMenuItemClick.bind(
      this
    );
  ...
  handleUserProfileOnEnter = event => {
    if (
      !event.currentTarget.children[0].classList.contains('profileIconHover')
    ) {
  ...
  handleSearch = () => {
    if (!this.state.expandSearchBar) this.actualChild.focusInput();
    else this.actualChild.blurInput();
  ...
  handleLoginMenuOpen = event => {
    this.setState({
      username: '',
      password: '',
      anchorElLogin: event.currentTarget
    });
  ...
  componentWillReceiveProps(props) {
    ...
    this.props.authCheckState().then(res => {
      if (this._isMounted) this.setState({ show_loggedin_status: true });
    });
  ...
  setMainMenuIndicator() {
    ...
    if (parts.length >= 2) {
      if (parts[1].length > 0) {
        ...
        if (
          path === 'sports_type' ||
          path === 'liveCasino_type' ||
          path === 'slot_type' ||
          path === 'lottery_type'
        )
          if (this._isMounted) this.setState({ mainTabValue: parts[1] });
      }
    }
  }
  ...
  bankingProfileMenuItemClick = () => {
    this.props.show_profile_menu();
    this.setState(state => ({
      showBankingProfileSubMenu: !state.showBankingProfileSubMenu
    }));
  ...
  analysisProfileMenuItemClick = () => {
    this.props.show_profile_menu();
    this.setState(state => ({
      showAnalysisProfileSubMenu: !state.showAnalysisProfileSubMenu
    }));
  ...
  userAccountProfileMenuItemClick = () => {
    this.props.show_profile_menu();
    this.setState(state => ({
      showUserAccountProfileSubMenu: !state.showUserAccountProfileSubMenu
    }));
  ...
  settingsProfileMenuItemClick = () => {
    this.props.show_profile_menu();
    this.setState(state => ({
      showSettingsProfileSubMenu: !state.showSettingsProfileSubMenu
    }));
  ...
  render() {
    ...
    const searchBackgroundStyle = !this.state.expandSearchBar
      ? {}
      : { display: 'block' };
      ...
      <div className={classes.root}>
            ...
            <Toolbar className={classes.appBar}>
              <div className={classes.sectionMobile}>
                <IconButton
                  ...
                  aria-label="Open drawer"
                  onClick={event => {
                    this.toggleSidePanel(event, 'showLeftPanel', true);
                  }}
                >
                  <MenuIcon />
                </IconButton>
                <Drawer
                  ...
                  onClose={event => {
                    this.toggleSidePanel(event, 'showLeftPanel', false);
                  }}
                >
                  <div
                    tabIndex={0}
              ...
              <div className={classes.sectionMobile}>
                ...
                <Popper
                  open={this.props.showAccountMenu}
                  anchorEl={anchorEl}
            ...
            >
              ...
              <StyledTab
                ...
                label={
                  <div>
                    <img
                      src={images.src + 'lottery.svg'}
                      className="lottery_type"
                    />
                    {lotteryMessage}
                  </div>
                }
              ...
              />
              <StyledTab style={{ width: 0, minWidth: 0 }} value="none" />
            </StyledTabs>
          </AppBar>
        </MuiThemeProvider>
        ...
        <Popper
          style={{
            position: 'absolute',
            top: 70,
            left: this.state.width > 380 ? this.state.width - 410 : 0
          }}
        ...
        <Popper
          ...
          style={{
            position: 'absolute',
            top: this.state.height > 650 ? (this.state.height - 650) / 2 : 0,
            left: this.state.width > 662 ? (this.state.width - 662) / 2 : 0
          }}
        >
          <Paper>
            <Signup />
        ...
        <Popper
          ...
          style={{
            position: 'absolute',
            top: this.state.height > 600 ? (this.state.height - 600) / 2 : 0,
            left: this.state.width > 662 ? (this.state.width - 662) / 2 : 0
          }}
        >
          <Paper>
        ...
        <Popper
          ...
          style={{
            position: 'absolute',
            top: this.state.height > 600 ? (this.state.height - 600) / 2 : 0,
            left: this.state.width > 662 ? (this.state.width - 770) / 2 : 0
          }}
        >
          <Paper>
        ...
        <Popper
          ...
          style={{
            position: 'absolute',
            top: this.state.height > 600 ? (this.state.height - 600) / 2 : 0,
            left: this.state.width > 770 ? (this.state.width - 770) / 2 : 0
          }}
        >
          <Paper>
            <One_Click_Finish />
        ...
        <Popper
          open={this.props.showSettledBets}
          anchorEl={anchorEl}
          className={classes.profilePopper}
          placement="top-start"
          transition
        ...
        <Popper
          open={this.props.showPromotions}
          anchorEl={anchorEl}
          className={classes.profilePopper}
          placement="top-start"
          transition
        ...
        <Popper
          open={this.props.showResponsibleGambling}
          anchorEl={anchorEl}
          className={classes.profilePopper}
          placement="top-start"
          transition
        ...
        <Popper
          open={this.props.showProfileMenu}
          anchorEl={anchorEl}
            ...
            <Fade {...TransitionProps} timeout={350}>
              <Paper className={classes.profileMenuPaper}>
                <List component="nav" aria-labelledby="nested-list-subheader">
                  <ListItem
                    button
                    onClick={this.bankingProfileMenuItemClick}
                    className={classes.mainMenuItem}
                  >
                    <ListItemText primary="Banking" />
                    {this.state.showBankingProfileSubMenu ? (
                      <ExpandLess />
                    ) : (
                      <ExpandMore />
                    )}
                  ...
                  <Collapse
                    in={this.state.showBankingProfileSubMenu}
                    timeout="auto"
                    unmountOnExit
                  ...
                  <ListItem
                    button
                    onClick={this.analysisProfileMenuItemClick}
                    className={classes.mainMenuItem}
                  >
                    <ListItemText primary="Analysis" />
                    {this.state.showAnalysisProfileSubMenu ? (
                      <ExpandLess />
                    ) : (
                      <ExpandMore />
                    )}
                  ...
                  <Collapse
                    in={this.state.showAnalysisProfileSubMenu}
                    timeout="auto"
                    unmountOnExit
                    className={classes.subMenu}
                  >
                  ...
                  <ListItem
                    button
                    onClick={this.userAccountProfileMenuItemClick}
                    className={classes.mainMenuItem}
                  >
                    <ListItemText primary="Account" />
                    {this.state.showUserAccountProfileSubMenu ? (
                      <ExpandLess />
                    ) : (
                      <ExpandMore />
                    )}
                  ...
                  <Collapse
                    in={this.state.showUserAccountProfileSubMenu}
                    timeout="auto"
                    unmountOnExit
                    className={classes.subMenu}
                  >
                  ...
                  <ListItem
                    button
                    onClick={this.responsibleGamingMenuItemClick}
                    className={classes.mainMenuItem}
                  >
                  ...
                  <ListItem
                    button
                    onClick={this.settingsProfileMenuItemClick}
                    className={classes.mainMenuItem}
                  >
                    <ListItemText primary="Settings" />
                    {this.state.showSettingsProfileSubMenu ? (
                      <ExpandLess />
                    ) : (
                      <ExpandMore />
                    )}
                  ...
                  <Collapse
                    in={this.state.showSettingsProfileSubMenu}
                    timeout="auto"
                    unmountOnExit
                    className={classes.subMenu}
                  >
