...
const amounts = Object.freeze([500, 1000, 2000, 5000]);
...
class DepositPayzod extends Component {
    ...
    amountChanged(event) {
        if (
            ...
            parseInt(event.target.value) > 500000 ||
    ...
    async handleClick(event) {
        ...
        var res = await axios.post(
            API_URL + 'accounting/api/payzod/deposit',
            postData,
            config
        );
                    ...
                    >
                        {qr_code ? (
                            <>
                                ...
                                />
                                <p>
                                    Once you have scanned the QR code, please
                                    check your e-mail and transaction history to
