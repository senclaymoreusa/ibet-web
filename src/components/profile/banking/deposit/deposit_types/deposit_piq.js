        ...
        <form>
          <Grid container>
            ...
            <Grid item xs={8} className={classes.titleRow}>
              <span className={classes.title}>{depositAmountMessage}</span>
            </Grid>
              ...
              <Grid container>
                  ...
                  >
                    {() => (
                      <TextField
                        ...
                        type="text"
                        error={
                          this.state.numberInvalid && this.state.numberFocused
                        }
                        helperText={
                          this.state.numberInvalid && this.state.numberFocused
                            ? "Please enter serial number between 9 and 15 digits"
                            : " "
                        }
                    ...
                    {() => (
                      <TextField
                        ...
                        helperText={
                          this.state.pinNumberInvalid &&
                          this.state.pinNumberFocused
                            ? "Please enter PIN number between 9 and 15 digits"
                            : " "
                        }
                        InputProps={{ disableUnderline: true }}
                      />
                ...
                <Grid item xs={6} className={classes.amountRow}>
                  <div className={classes.amountText}>
                    <FormattedNumber
                      value={
                        this.state.amount === "none" ? 0 : this.state.amount
                      }
          ...
          <div
            style={{ textAlign: "center", paddingLeft: 262, paddingRight: 262 }}
          >
            <div id="response-msg">
