...
export class MainAnalysis extends Component {
    ...
    render() {
        ...
        let sportBetsMessage = formatMessage({ id: "analysis.sport_bets" });
        let slotSpinsMessage = formatMessage({ id: "analysis.slot_spins" });
        let liveCasinoBetsMessage = formatMessage({ id: "analysis.live_casino_bets" });
            ...
            <div className={classes.root}>
                <Grid container>
                    ...
                    <Grid item xs={12} className={classes.titleCell}>
                        <div>
                            <span className={classes.titleLabel}>{titleMessage}</span>
