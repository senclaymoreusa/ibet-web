...
export class GameRuleFiveTh extends React.Component {
            ...
            <Grid container className={classes.content}>
                ...
                <Grid item xs={7} className={classes.detail}>
                    ...
                    <div id="HelperCenterDetail">
                        <h2>เกมหลายผู้เล่น</h2>
                        <p>1. หมายเลขพิเศษ
                            <br /> ผู้เล่นจะชนะหากหมายเลขพิเศษที่ชนะอยู่ในปัจจุบันจะเหมือนกันกับหมายเลขเดิมพัน
                            <br /> หมายเลขพิเศษสำหรับล็อตเตอรี่เยอรมันจะมีตั้งแต่หมายเลข 0 ถึงหมายเลข 9
                            <br /> 2. หมายเลขปกติ
