...
export class gbkeno extends React.Component {
  constructor(props) {
    super(props);
...
export default withStyles(styles)(injectIntl(withRouter(connect(mapStateToProps, { authCheckState, handle_referid, hide_landing_page,authUserUpdate })(gbkeno))));