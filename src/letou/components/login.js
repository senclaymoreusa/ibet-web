...
import { authLogin, authCheckState, AUTH_RESULT_SUCCESS, FacebookSignup, FacebookauthLogin, hide_letou_login, show_signup, show_forget_password } from '../../actions';
...
export default withStyles(styles)(injectIntl(withRouter(connect(mapStateToProps, { authLogin, authCheckState, FacebookSignup, FacebookauthLogin, hide_letou_login, show_signup, show_forget_password })(Login))));