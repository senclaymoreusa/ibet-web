export const messages = {
    en: {
        ...
        'deposit-attention-text':
            'Be sure to know: If the deposit amount is inconsistent with the amount applied this time, you will not be able to score! Please be considerate.',
