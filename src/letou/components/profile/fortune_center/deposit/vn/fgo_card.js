                ...
                <Grid container spacing={2} className={classes.contentGrid}>
                    ...
                    {/* <Grid item xs={12}>
                        <Select
                            ...
                            input={<BootstrapInput name="amount" id="bank-select" />}>
...
export default withStyles(styles)(withRouter(injectIntl(connect(mapStateToProps, { authCheckState, logout })(FgoCard))));