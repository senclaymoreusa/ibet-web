...
class MomoPay extends Component {
    constructor(props) {
        super(props);
            ...
            if (res === AUTH_RESULT_FAIL) {
                ...
                axios.get(API_URL + 'users/api/user/', config).then(res => {
                    this.setState({
                        ...
                        isFavorite:
                            res.data.favorite_payment_method === 'momopay'
                    });
                });
            }
        });
    ...
    handleClick(event) {
        ...
        axios
            .post(
                API_URL + 'accounting/api/transactions/save_momopay',
                postData,
                config
            )
            .then(res => {
                console.log(res);
                currentComponent.props.callbackFromParent('momopay');
            });
    }
    ...
    setAsFavorite(event) {
        axios
            .post(API_URL + `users/api/favorite-payment-setting/`, {
                ...
                payment: event.target.checked ? 'momopay' : null
            })
            .then(() => {
