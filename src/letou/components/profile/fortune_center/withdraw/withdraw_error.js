...
export class WithdrawError extends Component {
    constructor(props) {
        super(props);
...
export default withStyles(styles)(withRouter(injectIntl(connect(mapStateToProps, { authCheckState })(WithdrawError))));