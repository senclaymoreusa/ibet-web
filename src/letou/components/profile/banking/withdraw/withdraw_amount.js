...
export class WithdrawAmount extends Component {
    ...
    render() {
        ...
        let withdrawAmountMessage = formatMessage({ id: 'withdraw.withdraw_amount' });
...
export default withStyles(styles)(injectIntl(connect(mapStateToProps, { authCheckState })(WithdrawAmount)));