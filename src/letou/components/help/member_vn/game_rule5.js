...
export class GameRuleFiveVn extends React.Component {
        ...
        <div className={classes.root}> 
            ...
            <Grid container className={classes.content}>
                ...
                <Grid item xs={7} className={classes.detail}>
                    ...
                    <h2>Nhiều người chơi</h2>
                        <p>1. Special Number
                            <br /> Player wins if the current winning special number is the same with the bet number.
                            <br /> The special number for the German Lotto is drawn from number 0 to number 9.
                            <br /> 2. Normal Number
