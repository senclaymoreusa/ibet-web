...
export class MobileRegister extends Component {
    constructor(props) {
        super(props);
                ...
                <Grid container>
                    ...
                    <Grid item xs={2} className={classes.closeCell}>
                        <IconButton
                            ...
                            onClick={() => {
                                this.props.hide_letou_mobile_signup();
                            }}
                        >
                            <Clear />
                        </IconButton>
                    ...
                    >
                        <span className={classes.registerText}>
                            {this.getLabel('already-have-account')}
                        </span>
                        <Button
                    ...
                    >
                            ...
                            {this.state.password && (
                                <div className={classes.hintContainer}>
                                    ...
                                    <span className={classes.hintText}>
                                        {this.getLabel('register-hint1')}
                                    </span>
                                    <span className={classes.hintText}>
                                        {this.getLabel('register-hint2')}
                                    </span>
                                    <span className={classes.hintText}>
                                        {this.getLabel('register-hint3')}
                                    </span>
                                    <span className={classes.hintText}>
                                        {this.getLabel('register-hint4')}
                                    </span>
                                </div>
                            )}
                        </Grid>
                        <Grid item xs={12} style={{ paddingBottom: 30 }}>
                            <TextField
                                ...
                                onChange={event => {
                                    this.confirmPasswordChanged(event);
                                }}
                                onFocus={() => {
                                    this.setState({
                        ...
                        <Grid item xs={12}>
                            ...
                            <TextField
                                ...
                                helperText={
                                    ...
                                    this.state.phoneFocused
                                        ? this.getLabel('please-valid-phone')
                                        : ' '
                                }
                                InputProps={{
                                    disableUnderline: true,
                        ...
                        <Grid item xs={12} style={{ marginTop: 30 }}>
                            <TextField
                                ...
                                helperText={
                                    this.state.emailInvalid &&
                                    this.state.emailFocused
                                        ? this.getLabel('please-valid-email')
                                        : ' '
                                }
                                InputProps={{
                                    disableUnderline: true,
                    ...
                    >
                        <span className={classes.registerText}>
                            {this.getLabel('register-policy-text')}
                        </span>
                        <Button
                        ...
                        >
                            {this.getLabel('rules-privacy-policy')}
                        </Button>
                    </Grid>
                </Grid>
