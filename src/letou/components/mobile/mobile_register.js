...
export default withStyles(styles)(injectIntl(connect(mapStateToProps, { authCheckState, authSignup, handle_referid, hide_landing_page, show_letou_login })(MobileRegister)));