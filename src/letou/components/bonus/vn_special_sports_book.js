...
class VNSpecialSportsBookBonus extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <img className={classes.bannerImg} src={ images.src + "letou/bonus_images/VNSpecialSportsBook.jpg" } alt="Banner"/>

                <div className={classes.content}>

                    <h3 className={classes.mainHeading}>HOÀN TRẢ LÊN ĐẾN 1% TẠI o- THỂ THAO</h3>
                    <hr></hr>
...
export default withStyles(styles)(VNSpecialSportsBookBonus);
