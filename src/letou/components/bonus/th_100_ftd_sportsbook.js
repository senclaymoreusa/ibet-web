...
class TH100FTDSportsbookBonus extends React.Component {
    ...
    render() {
        ...
        return (
            <div>
                ...
                <img className={classes.bannerImg} src={ images.src + "letou/bonus_images/TH100FTDSportsbook.jpg" } alt="Banner"/>
                        ...
                        <div className={classes.mainInfoText}>
                            ...
                            <div>
                                <table className={classes.table}>
                                    ...
                                    <tr>
                                        <td className={classes.tableCell}>BTi และ OneWork</td>
                                        <td className={classes.tableCell}>2,500 บาท</td>
                                        <td className={classes.tableCell}>18 เท่า</td>
                                    </tr>
                                </table>
                            </div>
                            ...
                            <ul>
                                ...
                                <li>4. โบนัสนี้จะใช้ได้เฉพาะการวางเดิมใน พนันกีฬา BTi และ Onework เท่านั้น</li>
                                <li>5. สมาชิกใหม่ฝากเงินครั้งแรก ได้รับ 100% สูงสุด 2,500 บาท และจะต้องทำเทิร์นโอเวอร์ 18 เท่าจากยอดฝาก+โบนัส</li>
...
export default withStyles(styles)(TH100FTDSportsbookBonus);
