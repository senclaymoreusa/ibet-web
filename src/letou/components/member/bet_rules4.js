                ...
                <Grid item xs={7} className={classes.detail}>
                    ...
                    <div class="HelpCenterSmNav">
                        <ul>
                            ...
                            <li class={this.state.current == 13 ? "Active" : ""} onClick={this.onClick.bind(this,13)}>
                                <a>斯诺克</a>
                            </li>
                            <li class={this.state.current == 14 ? "Active" : ""} onClick={this.onClick.bind(this,14)}>
                                <a>乒乓球</a>
                            </li>
                            <li class={this.state.current == 15 ? "Active" : ""} onClick={this.onClick.bind(this,15)}>
                                <a>高尔夫球镖</a>
                            </li>
                            <li class={this.state.current == 16 ? "Active" : ""} onClick={this.onClick.bind(this,16)}>
                                <a>板球</a>
                            </li>
                            <li class={this.state.current == 17 ? "Active" : ""} onClick={this.onClick.bind(this,17)}>
                                <a>虚拟足球联赛 (VFL)</a>
                            </li>
                            <li class={this.state.current == 18 ? "Active" : ""} onClick={this.onClick.bind(this,18)}>
                                <a>电子竞技</a>
                            </li>
                            <li class={this.state.current == 19 ? "Active" : ""} onClick={this.onClick.bind(this,19)}>
                                <a>刀塔</a>
                            </li>
                            <li class={this.state.current == 20 ? "Active" : ""} onClick={this.onClick.bind(this,20)}>
                                <a>反恐精英:全球攻势</a>
                            </li>
                        </ul>
                    ...
                    <div id="HelperCenterDetail" >
                        ...
                        <div class="centerDetail" hidden={this.state.current != 5}>
                            ...
                            <div class="TableStyle3 MarginBottom20">
                                <table>
                                    <tbody>
                                        <tr>
                                            <td class="Title">盘口名称</td>
                                            <td class="Title">棒球术语</td>
                                        </tr>
                                        <tr>
                                            <td>局(Period)</td>
                                            <td>局(Inning)</td>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 12}>
                            <h2>飞镖</h2>
                            <h1>重要提醒</h1>
                            <p>如果比赛未能完成，所有未决盘口视为无效。</p>
                            <h1>结算及取消原则</h1>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 13}>
                            <h2>斯诺克</h2>
                            <h1>重要提醒</h1>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 14}>
                            <h2>乒乓球</h2>
                            <h1>重要提醒</h1>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 15}>
                            <h2>高尔夫球</h2>
                            <h1>重要提醒</h1>
                        ...
                        <div class="centerDetail"hidden={this.state.current != 16}>
                            <h2>板球</h2>
                            <h1>重要提醒</h1>
                            <p>除非明确说明，所有盘口不考虑超级轮。
                        ...
                        <div class="centerDetail" hidden={this.state.current != 17}>
                            <h2>虚拟足球联赛 (VFL)</h2>
                            <h1>如何玩</h1>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 18}>
                            <h2>电子竞技&nbsp;</h2>
                            <h1>一般盘口规则</h1>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 19}>
                            <h2>刀塔</h2>
                        ...
                        <div class="centerDetail" hidden={this.state.current != 20}>
                            <h2>反恐精英:全球攻势</h2>
